...
sim_size = 1 * w_ol + 1
wavelength = 1.550  # Wavelength in um
...
optical_system.add_element(MomentumSpacePlate(z_position=0, modulation_function=lambda X, Y: cp.exp(1j * 2 * cp.arctan2(Y, X))))
...
if plot_cross_sections:
    # Compute
    cross_z_positions = [0, 2*f1, 2*f1+d1, lens4.back_position]
    cross_sections \
